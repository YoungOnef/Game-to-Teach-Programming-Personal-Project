...
public class XYZManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        cubeCoordinatesText.text = "Cube Coordinates: " + position.x.ToString("F2") + ", " + position.y.ToString("F2") + ", " + position.z.ToString("F2");
        ...
        if (Input.GetMouseButtonDown(1))
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                clickCoordinatesText.text = "Clicked Coordinates: " + hitPoint.x.ToString("F2") + ", " + hitPoint.y.ToString("F2") + ", " + hitPoint.z.ToString("F2");
